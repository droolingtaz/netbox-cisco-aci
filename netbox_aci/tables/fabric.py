...
class ACIFabricTable(NetBoxTable):
    ...
    pod_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_aci:acipod_list",
        url_params={"aci_fabric_id": "pk"},
        verbose_name="Pods",
    )
    tags = columns.TagColumn(url_name="plugins:netbox_aci:acifabric_list")
...
class ACIPodTable(NetBoxTable):
    ...
    node_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_aci:acinode_list",
        url_params={"aci_pod_id": "pk"},
        verbose_name="Nodes",
    )
    tags = columns.TagColumn(url_name="plugins:netbox_aci:acipod_list")
...
class ACINodeTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name="plugins:netbox_aci:acinode_list")
