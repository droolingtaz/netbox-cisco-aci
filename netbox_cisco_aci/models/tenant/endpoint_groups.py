...
class ACIEndpointGroup(ACITenantBaseModel):
    ...
    aci_app_profile = models.ForeignKey(
        to="netbox_cisco_aci.ACIAppProfile",
        on_delete=models.PROTECT,
        related_name="endpoint_groups",
    ...
    class Meta(ACITenantBaseModel.Meta):
        ...
        constraints = (
            models.UniqueConstraint(
                ...
                name="netbox_cisco_aci_aciepg_ap_name_unique",
            ),
        )
    ...
    def get_absolute_url(self) -> str:
        return reverse("plugins:netbox_cisco_aci:aciendpointgroup", args=[self.pk])
...
class ACIUSegAttribute(ACITenantBaseModel):
    ...
    def get_absolute_url(self) -> str:
        return reverse("plugins:netbox_cisco_aci:aciusegattribute", args=[self.pk])
