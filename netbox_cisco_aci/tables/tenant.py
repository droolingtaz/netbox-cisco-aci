...
class ACITenantTable(NetBoxTable):
    ...
    vrf_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_cisco_aci:acivrf_list",
        url_params={"aci_tenant_id": "pk"},
        verbose_name="VRFs",
    )
    bd_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_cisco_aci:acibridgedomain_list",
        url_params={"aci_tenant_id": "pk"},
        verbose_name="BDs",
    )
    app_profile_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_cisco_aci:aciappprofile_list",
        url_params={"aci_tenant_id": "pk"},
        verbose_name="APs",
    )
    tags = columns.TagColumn(url_name="plugins:netbox_cisco_aci:acitenant_list")
...
class ACIVRFTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name="plugins:netbox_cisco_aci:acivrf_list")
...
class ACIBridgeDomainTable(NetBoxTable):
    ...
    subnet_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_cisco_aci:acibridgedomainsubnet_list",
        url_params={"aci_bridge_domain_id": "pk"},
        verbose_name="Subnets",
    )
    tags = columns.TagColumn(url_name="plugins:netbox_cisco_aci:acibridgedomain_list")
...
class ACIAppProfileTable(NetBoxTable):
    ...
    epg_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_cisco_aci:aciendpointgroup_list",
        url_params={"aci_app_profile_id": "pk"},
        verbose_name="EPGs",
    )
    tags = columns.TagColumn(url_name="plugins:netbox_cisco_aci:aciappprofile_list")
...
class ACIEndpointGroupTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name="plugins:netbox_cisco_aci:aciendpointgroup_list")
...
class ACIUSegAttributeTable(NetBoxTable):
    ...
    tags = columns.TagColumn(url_name="plugins:netbox_cisco_aci:aciusegattribute_list")
...
class ACIEndpointSecurityGroupTable(NetBoxTable):
    ...
    admin_shutdown = columns.BooleanColumn(verbose_name="Shutdown")
    qos_class = ChoiceFieldColumn(verbose_name="QoS")
    tags = columns.TagColumn(url_name="plugins:netbox_cisco_aci:aciendpointsecuritygroup_list")
